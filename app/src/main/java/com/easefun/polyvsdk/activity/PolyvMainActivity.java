...
public class PolyvMainActivity extends Activity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findIdAndNew();
        initView();
        ImageView iv_def = (ImageView) findViewById(R.id.iv_def);
        iv_def.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(PolyvMainActivity.this, PlayActivity.class));
            }
        });
